...
public class Plant {
    ...
    public void wateringInstructions(boolean needsWatering, String plantFamily, String Name) {
        ...
        if (needsWatering) {
            ...
            System.out.println("This plant named " + Name + " in the " + plantFamily + " plant family does not need any more water.");
        }
    ...
    public void sunlightRequirements(boolean hasSun, String plantFamily, String Name) {
        ...
        if (hasSun) {
            ...
            System.out.println("This plant named " + Name + " in the " + plantFamily + " plant family needs some more sunlight.");
